...
@IonicPage()
@Component({
  selector: 'page-mm-mostre',
  templateUrl: 'mm-mostre.html',
})
export class MmMostrePage {
...
//     }
//     this.nativePageTransitions.flip(options);
//     this.navCtrl.push(MenuPage, {datiMuseo: this.myMuseo, museoClass: this.myMuseoClass, ultimo: "MostreService"}, {animate: true, direction: "back"});
//     this.navCtrl.removeView(this.navCtrl.last());
//  }

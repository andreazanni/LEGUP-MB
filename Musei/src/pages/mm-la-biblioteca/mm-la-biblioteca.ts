...
@IonicPage()
@Component({
  selector: 'page-mm-la-biblioteca',
  templateUrl: 'mm-la-biblioteca.html',
})
export class MmLaBibliotecaPage {
  ...
  openMenu() {
    ...
    this.navCtrl.push(MenuPage, {datiMuseo: this.myMuseo, museoClass: this.myMuseoClass, ultimo: "BibliotecaService"}, {animate: true, direction: "back"});
    this.navCtrl.removeView(this.navCtrl.last());
 }

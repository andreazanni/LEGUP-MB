...
@IonicPage()
@Component({
  selector: 'page-mm-contatti',
  templateUrl: 'mm-contatti.html',
})
export class MmContattiPage {
  ...
  openMenu() {
    ...
    this.navCtrl.push(MenuPage, {datiMuseo: this.myMuseo, museoClass: this.myMuseoClass, ultimo: "ContattiService"}, {animate: true, direction: "back"});
    this.navCtrl.removeView(this.navCtrl.last());
 }

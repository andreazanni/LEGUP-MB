...
import { MmCondivisioneSocialPageModule } from '../mm-condivisione-social/mm-condivisione-social.module';
...
@IonicPage()
@Component({
  selector: 'page-mostre',
  templateUrl: 'mostre.html',
})
export class MostrePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public tts: TextToSpeech, public menuCtrl: MenuController, public nativePageTransitions: NativePageTransitions, public loadingCtrl: LoadingController, private calendar: Calendar, public alertCtrl: AlertController, public platform: Platform) {
  ...
  ionViewDidLoad() {
    ...
    var idClass = document.getElementById('paginaMostre');
    console.log(idClass);
    idClass.classList.add('mostre_musei');

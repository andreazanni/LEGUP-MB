...
var RicercaMuseiProvider = /** @class */ (function () {
    ...
    RicercaMuseiProvider.prototype.startRicercaMusei = function (options) {
        ...
        return new Promise(function (resolve) {
            ...
            _this.http.post('http://192.168.3.43:3000/api/musei', JSON.stringify(options), { headers: headers })
    ...
    RicercaMuseiProvider.prototype.getDatiMusei = function (options) {
        ...
        return new Promise(function (resolve) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            headers.append('Content-Type', 'application/json');
            _this.http.post('http://192.168.3.43:3000/api/museo', JSON.stringify(options), { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                resolve(data);
            }, function (error) {
